      ...
      <ThemeProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/manufacturing/stock-entry/party/:partyId" element={
              <ProtectedRoute>
                <Layout />
              </ProtectedRoute>
            } />
            ...
            <Route path="/manufacturing/reports/ink-stock" element={
              <ProtectedRoute>
                <Layout />
              </ProtectedRoute>
            } />
            <Route path="/manufacturing/reports/ink-issues" element={
              <ProtectedRoute>
                <Layout />
              </ProtectedRoute>
            } />
